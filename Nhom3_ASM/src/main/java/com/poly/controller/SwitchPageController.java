...
public class SwitchPageController {
	...
	public List<SanPham> getBongTai() {
		...
		SanPham sanPham4 = new SanPham(null, "Bông tai 4", 2500000.0, 2000000.0, null, null,
				"img/product/BongTai/bt4.png", null, null);
		list.add(sanPham1);
		list.add(sanPham2);
		list.add(sanPham3);
		list.add(sanPham4);
	...
	public List<SanPham> getDongHo() {
		...
		SanPham sanPham1 = new SanPham(null, "Đồng Hồ 1", 1000000.0, 800000.0, null, null,
				"img/product/DongHo/CalvinKlein/dh1.jpg", null, null);
		...
		SanPham sanPham3 = new SanPham(null, "Đồng Hồ 3", 1000000.0, 800000.0, null, null,
				"img/product/DongHo/JustCavalii/dh7.jpg", null, null);
		list.add(sanPham1);
		SanPham sanPham4 = new SanPham(null, "Đồng Hồ 4", 1000000.0, 800000.0, null, null,
				"img/product/DongHo/JustCavalii/dh8.jpg", null, null);
		list.add(sanPham1);
		list.add(sanPham2);
		list.add(sanPham3);
		list.add(sanPham4);
	...
	public List<SanPham> getNhan() {
		List<SanPham> list = new ArrayList<SanPham>();
		SanPham sanPham1 = new SanPham(null, "Nhẫn 1", 1000000.0, 800000.0, null, null,
				"img/product/NhanBac/anh1.png", null, null);
		SanPham sanPham2 = new SanPham(null, "Nhẫn 2", 2500000.0, 2000000.0, null, null,
				"img/product/NhacBac/anh2.png", null, null);
		SanPham sanPham3 = new SanPham(null, "Nhẫn 3", 2500000.0, 2000000.0, null, null,
				"img/product/NhanBac/anh3.png", null, null);
		SanPham sanPham4 = new SanPham(null, "Nhẫn 4", 2500000.0, 2000000.0, null, null,
				"img/product/NhanBac/anh4.png", null, null);
		list.add(sanPham1);
		list.add(sanPham2);
		list.add(sanPham3);
		list.add(sanPham4);
